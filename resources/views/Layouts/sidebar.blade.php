                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        <li class="submenu-item ">
                            <a href="{{ route('unit.index', ['type' => 'tk']) }}">TK</a>
                        </li>
                        <li class="submenu-item ">
                            <a href="{{ route('unit.index', ['type' => 'sd']) }}">SD</a>
                        </li>
                        <li class="submenu-item ">
                            <a href="{{ route('unit.index', ['type' => 'smp']) }}">SMP</a>
                        </li>
                        <li class="submenu-item ">
                            <a href="{{ route('unit.index', ['type' => 'sma']) }}">SMA</a>
                        </li>
                        <li class="submenu-item ">
                            <a href="{{ route('unit.index', ['type' => 'it']) }}">IT</a>
                        </li>
                        <li class="submenu-item ">
                            <a href="{{ route('unit.index', ['type' => 'sarpras']) }}">Sarpras</a>
                        </li>
                    </ul>
                </li>
